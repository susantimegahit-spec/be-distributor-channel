...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (!Schema::hasTable('customer_monthly_orders')) {
            Schema::create('customer_monthly_orders', function (Blueprint $table) {
                $table->id();
                ...
                $table->string('sap_last_doc_type', 50)->nullable();
                $table->string('sap_last_doc_num', 50)->nullable();
        ...
        if (!Schema::hasTable('customer_monthly_order_details')) {
            Schema::create('customer_monthly_order_details', function (Blueprint $table) {
                $table->id();
                $table->foreignId('customer_monthly_order_id')->constrained('customer_monthly_orders')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('customer_monthly_order_details');
        Schema::dropIfExists('customer_monthly_orders');
    }
};
