...
class StoreExternalCMORequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'doc_date.date'               => 'Format tanggal dokumen (doc_date) tidak valid.',
            'doc_date.after_or_equal'     => 'Tanggal dokumen (doc_date) tidak boleh backdate (harus tanggal hari ini atau tanggal mendatang).',
